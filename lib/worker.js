...
// });
//
// fs.readdirSync(path.resolve(sumanIndex + '/lib/injection')).forEach(function (item) {
//   sumanFilesToLoad.push(`lib/${item}`);
// });
//
...
// });
//
// fs.readdirSync(path.resolve(sumanIndex + '/lib/index-helpers')).forEach(function (item) {
//   sumanFilesToLoad.push(`lib/${item}`);
// });
//
// fs.readdirSync(path.resolve(sumanIndex + '/lib/acquire-dependencies')).forEach(function (item) {
//   sumanFilesToLoad.push(`lib/${item}`);
// });
